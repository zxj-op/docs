---
openapi: POST /twitter/video/mai/transcript
title: Twitter Video MAI Transcript
description: "Get Twitter video transcript using MAI."
---

This endpoint allows you to retrieve transcript for a Twitter video using MAI method.
...
def twitter_video_mai_transcript(video_url: str):
    url = f"{BASE_URL}/twitter/video/mai/transcript"
    data = {"video_url": video_url}
    resp = requests.post(url, headers=HEADERS, json=data)
    return resp.json()

# Usage example
result = twitter_video_mai_transcript("https://x.com/NBCOlympics/status/1989901761650323606")
print(result)
```
...
```json Callback Response
{
        ...
        "data": [
          {
            "end_time": 19.0,
            "start_time": 0.0,
            "transcript": "A man in a blue jacket and red gloves sits between two women, all three looking at something off-screen. The man gestures with his hands, then covers his mouth in surprise, his eyes wide. The women on either side of him smile and laugh, one patting his arm. The man then throws his hands up in excitement, then covers his face with his red-gloved hands, appearing to cry tears of joy. The women continue to smile and laugh, one of them patting his shoulder."
          }
        ],
        "error_rate": 0.0,
        "usage_metadata": {
        ...
        "data": [
          {
            ...
            "speaker": null,
            "start_time": 0.0,
            "text": " Wait for his reaction."
          },
          {
            "end_time": 5.0,
            "speaker": null,
            "start_time": 3.0,
            "text": " Yes, first place."
          },
          {
            "end_time": 7.0,
            "speaker": null,
  ...
  "task_id": "3adc70ed358b469da2c0553a59c5f2c5"
}
```
</ResponseExample>
...
When the Twitter video transcription is complete, a callback will be sent to your configured webhook URL.
